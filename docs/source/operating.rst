...
.. code-block::
   ...
   docker run -d -p 49065:49065 -p 42813:42813 -p 48475:48475 -p 8883:8883 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=49065 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=42813  \
          --env SOLUTIONVIPERVIZPORT=48475 \
          --env DOCKERUSERNAME='sajoshi4' \
          --env CLIENTPORT=8883  \
          --env EXTERNALPORT=43029 \
          --env KAFKACLOUDUSERNAME='' \
          --env VIPERVIZPORT=9005 \
          --env MQTTUSERNAME='sajoshi4' \
          --env AIRFLOWPORT=9000  \
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=49065, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37935, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43557, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46737, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45977, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46409, HPDEHOST=127.0.1.1, HPDEPORT=43379, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40917

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6077-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, python-preprocess-8046-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, python-ai-8710-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
