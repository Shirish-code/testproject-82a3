[testproject-82a3] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [testproject-82a3] container is NOT running**.

.. tip::
   You must have your [testproject-82a3] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Shirish-code/Rasberrypie/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Shirish-code/Rasberrypie.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39825  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Shirish-code'  \-\-env DOCKERUSERNAME='sajoshi4'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   sajoshi4/testproject-82a3-amd64 (https://hub.docker.com/r/sajoshi4/testproject-82a3-amd64)
...
.. code-block::
   ...
   docker run -d -p 57707:57707 -p 47975:47975 -p 42569:42569 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=testproject-82a3 \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-testproject-82a3 \
          --env GITUSERNAME=Shirish-code \
          --env GITREPOURL=https://github.com/Shirish-code/Rasberrypie.git \
          --env SOLUTIONEXTERNALPORT=57707 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=47975  \
          --env SOLUTIONVIPERVIZPORT=42569 \
          --env DOCKERUSERNAME='sajoshi4' \
          --env CLIENTPORT=8883  \
          --env EXTERNALPORT=39825 \
          --env KAFKACLOUDUSERNAME='' \
          --env VIPERVIZPORT=9005 \
          ...
          sajoshi4/testproject-82a3-amd64
...
[testproject-82a3] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Shirish-code/Rasberrypie/tree/main/tml-airflow/dags/tml-solutions/testproject-82a3
...
.. important::
   https://testproject-82a3.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-testproject-82a3
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=57707, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45399, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43765, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36125, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=44565, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=43129, HPDEHOST=127.0.1.1, HPDEPORT=39833, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=34421

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9360-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, python-preprocess-5799-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, python-ai-3967-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, python-produce-8242-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, python-preprocess-675-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, python-ai-83-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, python-produce-6964-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, python-preprocess-4630-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, python-ai-199-testproject-82a3,solution_preprocessing_ai_mqtt_dag-testproject-82a3, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
